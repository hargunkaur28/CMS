    ...
    <div className="max-w-7xl mx-auto h-full flex flex-col">
      ...
      <Card className="flex-1 p-8 text-center bg-surface-container-low border-dashed border-2 border-white/5 rounded-2xl flex flex-col items-center justify-center min-h-[400px]">
        <div className="max-w-md mx-auto py-12">
          <div className="w-16 h-16 bg-black/5 text-black rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-black/5">
            <Calendar size={32} />
          </div>
          ...
          <button className="px-6 py-2 bg-black text-white rounded-lg font-utility font-bold text-sm shadow-lg shadow-black/10 hover:opacity-90 transition-all active:scale-95">
